...
function AddToCartButton({ product, disabled }: AddToCartButtonProps) {
  ...
  // Use useEffect to set isClient to tru after component mounts
  ...
  return (
    <div className="flex items-center justify-center space-x-2">
      ...
      <button
        ...
        className={`w-8 h-8 rounded-full flex items-center justify-center transition-colors duration-200 ${disabled ? "bg-gray-400 cursor-not-allowed" : "bg-violet-500 hover:bg-violet-500/85"}`}
        disabled={disabled}
      >
